...
namespace EFCodeFirstDemo.Controllers
{
    ...
    {
        private EFCodeFirstDemoContext db = new EFCodeFirstDemoContext();
        ...
        public ActionResult Create([Bind(Include = "LicenseNumber,IssuingCountry,Issued,Expires")] DrivingLicense drivingLicense)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LicenseNumber,IssuingCountry,Issued,Expires")] DrivingLicense drivingLicense)
        {
            if (ModelState.IsValid)
            {
